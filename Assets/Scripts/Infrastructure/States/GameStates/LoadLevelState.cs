...
namespace Infrastructure.States.GameStates
{
    public class LoadLevelState : IState
    {
        ...
        private async void InstantiateAll()
        {
            ...
            ghost.GetComponent<GhostInfo>().SetUpGhost(_staticDataService.GetRandomGhost(), hero, hero.GetComponent<MoveControl>().GetPlayerHuntPoint(), _levelSetUp.CurrGhostRoom, hero.GetComponent<RoomIdentifire>(), hero.GetComponent<SanityHandler>(), _levelSetUp.CurrLevelSize, _levelSetUp.MainDoors);
