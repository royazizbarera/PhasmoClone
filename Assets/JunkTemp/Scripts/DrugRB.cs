...
{
	public float m_DoorPickupRange = 2.5f;
	public float m_DoorThrow = 15f;
	public float m_DoorDistance = 3f;
...
public class DrugRB : MonoBehaviour
{
	...
	private void holdObject()
	{
		...
		objectHeld.GetComponent<Rigidbody>().velocity = (nextPos - currPos) * 15;
